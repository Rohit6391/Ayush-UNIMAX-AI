    ...
    return (
        <TextGenerator
            ...
            generatePrompt={(p: string) => 
                `You are a professional photographer. Suggest the ideal camera settings (Aperture, Shutter Speed, ISO) for the following scenario. Explain why these settings are appropriate. Scenario: "${p}"`
            }
