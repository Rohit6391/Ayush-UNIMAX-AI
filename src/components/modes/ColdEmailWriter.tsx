    ...
    return (
        <TextGenerator
            ...
            generatePrompt={(prompt) => 
                `You are a sales expert. Write a concise, professional, and effective cold email for the following purpose. The email should be personalized and have a clear call to action. Purpose: "${prompt}"`
            }
