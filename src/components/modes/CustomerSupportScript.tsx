    ...
    return (
        <TextGenerator
            ...
            generatePrompt={(prompt) => 
                `You are a customer support manager. Write a polite and effective script for a support agent to handle the following scenario. Include an opening, empathy statements, and steps to resolution. Scenario: "${prompt}"`
            }
