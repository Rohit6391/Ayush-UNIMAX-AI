    ...
    return (
        <TextGenerator
            ...
            generatePrompt={(p: string) => 
                `You are a professional DJ. Suggest an order for a playlist to create a specific mood or energy flow for the following event. Describe the flow (e.g., start slow, build energy, peak, cool down). Event: "${p}"`
            }
