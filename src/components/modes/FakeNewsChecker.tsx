    ...
    return (
        <TextGenerator
            ...
            generatePrompt={(p: string) => 
                `You are a fact-checker. Analyze the following news story or claim for signs of being fake news. Provide an assessment and explain your reasoning. Claim: "${p}"`
            }
