        ...
        <Maker
            ...
            generatePrompt={(prompt) =>
                ...
                **Requirements**:
                ...
                2.  **Game Logic**: All game logic must be written in JavaScript within a \`<script>\` tag.
                ...
                8.  **No Commentary**: The entire response must be ONLY the HTML code. Do not include any explanations, comments, or markdown backticks.
