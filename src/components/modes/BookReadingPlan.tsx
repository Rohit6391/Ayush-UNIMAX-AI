    ...
    return (
        <TextGenerator
            ...
            generatePrompt={(prompt) => 
                `You are a librarian and reading coach. Create a structured reading plan based on the following goal. Break it down into manageable parts (e.g., chapters per week) and include milestones. Goal: "${prompt}"`
            }
