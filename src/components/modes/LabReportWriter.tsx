    ...
    return (
        <TextGenerator
            ...
            generatePrompt={(prompt) => 
                `You are a scientific writer. Write a lab report based on the following experiment. Include sections for Introduction, Methods, Results, and Conclusion. Experiment: "${prompt}"`
            }
