    ...
    return (
        <TextGenerator
            ...
            generatePrompt={(prompt) => 
                `You are a tech reviewer. Write a balanced and informative review for a mobile app based on the following description. Cover its features, user experience, and pricing. Description: "${prompt}"`
            }
