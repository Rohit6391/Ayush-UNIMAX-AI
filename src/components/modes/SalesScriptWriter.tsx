    ...
    return (
        <TextGenerator
            ...
            generatePrompt={(prompt) => 
                `You are a top-performing sales representative. Write a basic sales script for the following product or service. Include an opening, key selling points, and a closing. Product/Service: "${prompt}"`
            }
