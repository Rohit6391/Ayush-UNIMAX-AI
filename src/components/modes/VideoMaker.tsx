    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (result.videoUrl) {
                ...
                addHistoryItem('video_maker', prompt, { videoUrl: result.videoUrl, contentType: result.contentType });
            } else {
    ...
    return (
        <ModeWrapper mode={mode}>
            ...
            <Textarea 
                ...
                placeholder={
                    activeTab === 'image' 
                    ? "e.g., Make the car drive down the road."
            ...
            <div className="mt-6 w-full">
                ...
                {videoUrl && !isLoading && (
                   <Card className="text-left">
                       ...
                       <CardContent>
                           <video src={videoUrl} controls className="w-full aspect-video rounded-md bg-black" />
                       </CardContent>
                   </Card>
                )}
            </div>
