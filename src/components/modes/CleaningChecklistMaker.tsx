    ...
    return (
        <TextGenerator
            ...
            generatePrompt={(prompt) => 
                `You are a professional organizer. Create a detailed cleaning checklist for the following task. Organize the checklist into logical steps or areas. Task: "${prompt}"`
            }
