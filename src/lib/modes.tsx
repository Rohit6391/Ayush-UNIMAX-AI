...
export const modes: Mode[] = [
    ...
    { id: 'shopping_assistant', name: 'Shopping Assistant', icon: ShoppingCart, description: 'Find a link to purchase a product.', component: TextGenerator },
