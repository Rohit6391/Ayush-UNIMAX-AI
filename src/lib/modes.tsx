...
import { AIvirtualInteriorDesigner } from '@/components/modes/AIVirtualInteriorDesigner';
import { HomeRenovationPlanner } from '@/components/modes/HomeRenovationPlanner';
import { MealPrepPlanGenerator } from '@/components/modes/MealPrepPlanGenerator';
import { CustomWorkoutGenerator } from '@/components/modes/CustomWorkoutGenerator';
import { PersonalFinanceAdvisor } from '@/components/modes/PersonalFinanceAdvisor';
import { DIYGiftIdeaGenerator } from '@/components/modes/DIYGiftIdeaGenerator';
import { EventSeatingChartPlanner } from '@/components/modes/EventSeatingChartPlanner';
import { WeddingVowWriter } from '@/components/modes/WeddingVowWriter';
import { CoverSongSuggestionTool } from '@/components/modes/CoverSongSuggestionTool';
import { MusicAlbumArtCreator } from '@/components/modes/MusicAlbumArtCreator';
import { PodcastShowNotesGenerator } from '@/components/modes/PodcastShowNotesGenerator';
import { StandUpComedySetWriter } from '@/components/modes/StandUpComedySetWriter';
import { FlashFictionGenerator } from '@/components/modes/FlashFictionGenerator';
import { HistoricalEventExplainer } from '@/components/modes/HistoricalEventExplainer';
import { AncientCivilizationGuide } from '@/components/modes/AncientCivilizationGuide';
import { StartupLaunchChecklist } from '@/components/modes/StartupLaunchChecklist';
import { BrandStoryCreator } from '@/components/modes/BrandStoryCreator';
import { ProductLaunchTimelinePlanner } from '@/components/modes/ProductLaunchTimelinePlanner';
import { TeamBuildingActivityGenerator } from '@/components/modes/TeamBuildingActivityGenerator';
import { ExecutiveSummaryWriter } from '@/components/modes/ExecutiveSummaryWriter';
import { CareerChangePlanner } from '@/components/modes/CareerChangePlanner';
import { JobApplicationTracker } from '@/components/modes/JobApplicationTracker';
import { InterviewThankYouNoteWriter } from '@/components/modes/InterviewThankYouNoteWriter';
import { CodeSnippetExplainer } from '@/components/modes/CodeSnippetExplainer';
import { APIIntegrationPlanner } from '@/components/modes/APIIntegrationPlanner';
import { DatabaseSchemaDesigner } from '@/components/modes/DatabaseSchemaDesigner';
import { SoftwareTestingPlanCreator } from '@/components/modes/SoftwareTestingPlanCreator';
import { AboutAiChat } from '@/components/panels/AboutAiChat';
export type ModeId = 
  // Core
  | 'chat' | 'fun_chat' | 'voice_chat' | 'about_ai_chat'
  // Creative & Media
...
export const modes: Mode[] = [
    ...
    { id: 'about_ai_chat', name: 'About AI', icon: HelpCircle, description: 'Learn about this application and its features.', component: AboutAiChat },
