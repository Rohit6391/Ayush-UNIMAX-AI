...
export const modes: Mode[] = [
    ...
    { id: 'lab_report_formatter', name: 'Lab Report Formatter', icon: TestTube, description: 'Format raw lab notes into a structured lab report.' },
    ...
    { id: 'event_agenda_creator', name: 'Event Agenda Creator', icon: FileText, description: 'Create a detailed event agenda.', component: TextGenerator, componentProps: textGeneratorProps('Event Agenda', 'Describe your event to create a detailed agenda.', 'Create an event agenda') },
