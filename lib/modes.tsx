...
import {
    ...
    Plane, Moon, Presentation, Feather, UserSquare, Scale, Stethoscope, Landmark, CheckSquare, Music, BarChart3, Bot, Video as VideoIcon, Dumbbell, Trophy
} from 'lucide-react';
...
export type ModeId = 
  ...
  | 'character_generator' | 'fact_checker' | 'chart_maker' | 'fact_giver' | 'fun_chat' | 'grammar_practice_creator'
  | 'sports_skills_trainer' | 'quiz_generator' | 'book_generator' | 'about_ai_chat';
...
export const modes: Mode[] = [
    ...
    { id: 'dream_interpreter', name: 'Dream Interpreter', icon: Moon, description: 'Analyze and find the meaning of your dreams.', component: TextGenerator, componentProps: {
